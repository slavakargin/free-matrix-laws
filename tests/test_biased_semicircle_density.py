...
from free_matrix_laws import matrix_semicircle_density, biased_matrix_semicircle_density
...
def test_biased_matches_unbiased_when_a0_zero():
    ...
    x = 0.2
    f_unb = matrix_semicircle_density(x, A, eps=1e-2, tol=1e-11, maxiter=4000)
    f_bia = biased_matrix_semicircle_density(x, a0, A, eps=1e-2, tol=1e-11, maxiter=4000)
...
def test_biased_rejects_wrong_shape_a0():
    ...
    try:
        _ = biased_matrix_semicircle_density(0.0, bad, A)
    except ValueError:
        pass
    else:
